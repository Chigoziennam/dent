  ...
  return (
    <div className="relative flex min-h-dvh items-center justify-center bg-base px-5 py-8">
      ...
      >
        ...
        {/* OAuth row — GitHub + Google only (builders' doors) */}
        <div className="mt-4 grid grid-cols-2 gap-2">
          <motion.button type="button" whileTap={{ scale: 0.96 }} onClick={() => oauth('github')} disabled={busy}
            className="flex items-center justify-center gap-2 rounded-xl border border-line bg-white/[0.03] py-3 text-sm font-medium text-primary transition-colors hover:border-line-hover disabled:opacity-50"
