...
export default function Integrations() {
  const { creds, setCreds, events, dailyLogs, profile } = useShipLog()
    ...
    el.innerHTML = `
      <div style="font-family: Helvetica, Arial, sans-serif; color: #1a1a2e; padding: 32px; max-width: 700px;">
        <div style="display:flex; justify-content:space-between; align-items:baseline; border-bottom: 3px solid #6366f1; padding-bottom: 12px;">
          <div>
            <div style="font-size: 26px; font-weight: 800;">ShipLog — Proof of Work</div>
        ...
        <div style="margin-top: 20px; font-size: 11px; color: #999; text-align: center;">Generated by ShipLog · Build in Public. Without Thinking About It. · Powered by Nalto</div>
      </div>`
    await html2pdf().set({
      margin: 8,
      filename: `shiplog-${profile.username}-${from}-to-${to}.pdf`,
      html2canvas: { scale: 2 },
      ...
      >
        ...
        <motion.div variants={{ initial: { opacity: 0, y: 16 }, animate: { opacity: 1, y: 0 } }}
          ...
          <div className="mt-3.5 space-y-2">
            ...
            <a href="https://github.com/settings/tokens/new?description=ShipLog&scopes=repo,read:user" target="_blank" rel="noreferrer"
